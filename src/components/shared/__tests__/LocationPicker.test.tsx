...
describe('LocationPicker', () => {
  ...
  describe('Search Behavior', () => {
    ...
    it('collapses two results that carry the same place name', async () => {
      ...
      // The list also carries the "take the text as written" row, which is
      // there whenever there is text: count the geocoded rows only.
      const geocoded = screen
        .getAllByRole('option')
        .filter((option) => option.dataset.testid !== 'location-use-typed');
